...
<body class="bg-dark">
    ...
    <div class="container-fluid">
        ...
        <ul class="container bg-white">
            <li>Admin : Michel Delpech</li>        
            <li>Email : michel@enekatestream.com</li>
            <li>Age : 35 ans</li>
        </ul>
        <ul class="container bg-white">
            <li>CoOpérateur : Franck dubosc</li>
            <li>Email : francky@enekatestream.com</li>
            <li>Age : 48 ans</li>
        </ul>
