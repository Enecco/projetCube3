...
?>
    ...
    <div class="card mb-3 col-3">
        ...
        <div class="card-body">
          <h5 class="card-title">Enecco Jacobelli</h5>
          <h6 class="card-subtitle text-muted">Contact devis</h6>
        </div>
        <!-- <svg xmlns="http://www.w3.org/2000/svg" class="d-block user-select-none" width="100%" height="200" aria-label="Placeholder: Image cap" focusable="false" role="img" preserveAspectRatio="xMidYMid slice" viewBox="0 0 318 180" style="font-size:1.125rem;text-anchor:middle">
          <rect width="100%" height="100%" fill="#868e96"></rect>
          <text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text>
        </svg> -->
        <img src="PC3/Application/view/img/enecco.jpg" alt="delpech">
        <div class="card-body">
          <p class="card-text">Cursus commercial, technique.</p>
        </div>
        <ul class="list-group list-group-flush">
          <li class="list-group-item">Téléphone : 06 06 06 06 06</li>
          <li class="list-group-item">Email : quentin.picat@viacesi.fr</li>
        </ul>
        <div class="card-body">
    ...
    <div class="card mb-3 col-3">
        <h3 class="card-header">Administrateur</h3>
        <div class="card-body">
          <h5 class="card-title">Quentin Picat</h5>
          <h6 class="card-subtitle text-muted">Contact recrutement</h6>
        </div>
